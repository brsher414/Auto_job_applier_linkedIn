...
# Your legal name
first_name = "Zhibi"               # Your first name in quotes Eg: "First", "Sai"
middle_name = ""                   # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Liu"                  # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "15921101277"       # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Shanghai, China"   # Los Angeles, San Francisco, etc.
'''
